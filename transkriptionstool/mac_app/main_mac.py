...
Optimierte Version für Mac-Betriebssystem
"""
...
class TranskriptionsApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Transkriptionstool")
        self.root.geometry("650x450")
        self.root.resizable(True, True)
        
        # Mac-spezifische Einstellungen
        self.setup_mac_styling()
    ...
    def setup_mac_styling(self):
        """Mac-spezifische Stilanpassungen"""
        # Fenster-Stil für macOS
        try:
            self.root.tk.call('tk', 'scaling', 2.0)  # Für Retina-Displays
        except:
            pass
    ...
    def create_widgets(self):
        ...
        upload_frame = ttk.LabelFrame(main_frame, text="Datei auswählen", padding="15")
        upload_frame.pack(fill=tk.X, pady=(0, 20))
        
        # Datei auswählen Button (macOS-Stil)
    ...
    def open_in_finder(self, file_path):
        """Öffnet den Ordner der Datei im Finder"""
        try:
            import subprocess
